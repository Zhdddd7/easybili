      ...
      <div class="video-user-info">
        ...
        <div class="user-info">
          ...
          <div class="introduction">
            {{ userInfo.personIntroduction || "This person is mysterious~~~" }}
          </div>
          <div class="op-btns">
            <router-link
              class="btn-go-home"
