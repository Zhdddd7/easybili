  ...
  <div class="comment-item">
    ...
    <div class="comment-content-panel">
      ...
      <div v-if="data.imgPath" class="image-show">
        <Cover :source="data.imgPath + proxy.imageThumbnailSuffix" :preview="true" fit="cover"></Cover>
      </div>
      <div class="comment-op">
        ...
        <el-dropdown v-if="data.userId==loginStore.userInfo.userId||videoInfo.userId==loginStore.userInfo.userId">
          <span class="op-right iconfont icon-more">
          </span>
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item @click="topComment"
                v-if="videoInfo.userId==loginStore.userInfo.userId&&data.pCommentId==0">{{data.topType==1?"取消置顶":"置顶"}}</el-dropdown-item>
              <el-dropdown-item @click="delComment"
                v-if="videoInfo.userId==loginStore.userInfo.userId||data.userId==loginStore.userInfo.userId">删除</el-dropdown-item>
            </el-dropdown-menu>
          </template>
        </el-dropdown>
      </div>
