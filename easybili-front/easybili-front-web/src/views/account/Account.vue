        ...
        >
          ...
          <el-form-item prop="checkCode">
            <div class="check-code-panel">
              <el-input
                size="large"
                placeholder="please enter the checkcode"
...
const rules = {
  email: [
    ...
    { validator: proxy.Verify.email, message: "please enter a right form of email" },
  ],
  password: [{ required: true, message: "please enter the password" }],
  nickName: [{ required: true, message: "please enter the user name" }],
  registerPassword: [
    { required: true, message: "please enter the password" },
    {
      validator: proxy.Verify.password,
      message: "The password has to be 8-18 length digits, alphabets, specials combination",
    },
  ],
  reRegisterPassword: [
  ...
  checkCode: [{ required: true, message: "please enter the checkcode" }],
};
...
const doSubmit = () => {
  formDataRef.value.validate(async (valid) => {
    ...
    //注册返回
    if (opType.value == 0) {
      proxy.Message.success("Register success, please login");
      showPanel(1);
