      ...
      <div class="search-panel" @click.stop v-if="route.path != '/search'">
        <div class="search-panel-inner">
          ...
          <div class="history-panel" v-if="showHistory">
            ...
            <div class="hot-search-title">Trending</div>
      ...
      <div class="user-avatar">
        <template v-if="Object.keys(loginStore.userInfo).length > 0">
          ...
          <div class="user-info-panel">
            <div class="nick-name">{{ loginStore.userInfo.userName }}</div>
            <div class="count-info">
              ...
              <div class="count-info-item">
                ...
                <div class="count-title">Coins</div>
              </div>
            </div>
            <router-link
...
const placeholder = ref("DogCatcher");
const keyword = ref();
